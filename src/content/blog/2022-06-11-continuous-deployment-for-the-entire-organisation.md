...
And since they were the ones *at the end* of the process, they became the ones pushing the deployment button, in the end. And only the QA team really knew what it *meant* to *deploy BRYTER*.
